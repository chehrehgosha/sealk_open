...
var optimizationCallback = require("./optimizationCallback").optimizationCallback;
var fs = require("fs");
...
function dataProcessor(linesOfData, processLimit) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    numberOfLines = linesOfData.length;
                    numberOfIterations = Math.floor(numberOfLines / processLimit);
                    index = 0;
                    _a.label = 1;
                case 1:
                    if (!(index <= numberOfIterations)) return [3 /*break*/, 4];
                    startIndex = index * processLimit;
                    endIndex = index === numberOfIterations ? numberOfLines : (index + 1) * processLimit;
                    console.log("### Processing on data index " + startIndex + " to " + endIndex + "...");
                    processRequests = linesOfData
                    ...
                    return [4 /*yield*/, Promise.all(processRequests).then(function (values) {
